          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex gap-4 flex-wrap">
              <Input
                ...
                className="max-w-xs dark:bg-gray-700 dark:text-gray-200"
              />
              <Button
  ...
  {vaccines
    ...
    .map((vaccine) => {
      ...
      return (
        <div
                      key={vaccine._id}
                      className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors"
                    >
                      <div className="flex items-center gap-4">
                        <status.icon
                          className={`w-5 h-5 ${

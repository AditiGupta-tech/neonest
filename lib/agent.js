...
class JSONAgent extends Agent{
    constructor(
        ...
        \`\`\`JSON
        {
            ...
            "actionName": //any value from below,
        ...
        "type": // nap, nightsleep (not other than this),
        "duration"://amount according to type,
        "mood"://mood if given else null
        "notes"://the note according to the reply
        }
        ...
        if the media is nothing do not add notification for memory
